...
@php
    ...
    $popularCategories = App\Models\Category::orderBy('category_name', 'ASC')->limit(7)->get();
@endphp
            ...
            <div class="row">
                ...
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".1s">
                    ...
                    <ul class="footer-list mb-sm-5 mb-md-0">
                        ...
                        <li><a href="{{ route('page.delivery') }}">Delivery Information</a></li>
                        ...
                        <li><a href="{{ route('page.support') }}">Support Center</a></li>
                ...
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".2s">
                    ...
                    <ul class="footer-list mb-sm-5 mb-md-0">
                        ...
                        <li><a href="{{ auth()->check() ? route('wishlist') : route('login') }}">My Wishlist</a></li>
                        <li><a href="{{ route('public.track.order') }}">Track My Order</a></li>
                        <li><a href="{{ route('page.contact') }}?subject=Help Ticket">Help Ticket</a></li>
                        <li><a href="{{ route('page.delivery') }}">Shipping Details</a></li>
                        <li><a href="{{ auth()->check() ? route('compare') : route('login') }}">Compare Products</a></li>
                    </ul>
                </div>
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".3s">
                    ...
                    <ul class="footer-list mb-sm-5 mb-md-0">
                        ...
                        <li><a href="{{ route('page.affiliate') }}">Affiliate Program</a></li>
                        <li><a href="{{ route('page.farm') }}">Farm Business</a></li>
                        <li><a href="{{ route('page.careers') }}">Farm Careers</a></li>
                        <li><a href="{{ route('vendor.all') }}">Our Suppliers</a></li>
                        <li><a href="{{ route('page.accessibility') }}">Accessibility</a></li>
                        <li><a href="{{ route('page.promotions') }}">Promotions</a></li>
                    </ul>
                </div>
                <div class="footer-link-widget col wow animate__animated animate__fadeInUp" data-wow-delay=".4s">
                    ...
                    <ul class="footer-list mb-sm-5 mb-md-0">
                        ...
                        @empty
                            <li><a href="{{ route('shop.page') }}">Browse Shop</a></li>
                        @endforelse
                    </ul>
                </div>
            </div>
    ...
    <div class="container pb-30 wow animate__animated animate__fadeInUp" data-wow-delay="0">
        <div class="row align-items-center">
            ...
            <div class="col-xl-4 col-lg-6 col-md-6">
                <p class="font-sm mb-0">&copy; {{ date('Y') }}, <strong class="text-brand">MukamGhor</strong> - {{ $setting?->copyright ?? 'All rights reserved' }}</p>
            </div>
            ...
            <div class="col-xl-4 col-lg-6 col-md-6 text-end d-none d-md-block">
                <div class="mobile-social-icon">
                    <h6>Follow Us</h6>
                    @if($setting?->facebook)
                        <a href="{{ $setting->facebook }}" target="_blank" rel="noopener"><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-facebook-white.svg') }}" alt="Facebook" /></a>
                    @endif
                    @if($setting?->twitter)
                        <a href="{{ $setting->twitter }}" target="_blank" rel="noopener"><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-twitter-white.svg') }}" alt="Twitter" /></a>
                    @endif
                    @if($setting?->youtube)
                        <a href="{{ $setting->youtube }}" target="_blank" rel="noopener"><img src="{{ asset('frontend/assets/imgs/theme/icons/icon-youtube-white.svg') }}" alt="YouTube" /></a>
                    @endif
                </div>
