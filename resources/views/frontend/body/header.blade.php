                    ...
                    <div class="col-xl-3 col-lg-4">
                        <div class="header-info">
                            <ul>
                                ...
                                <li><a href="{{ route('public.track.order') }}">Order Tracking</a></li>
                            </ul>
                        </div>
                    </div>
            ...
            <div class="container">
                <div class="header-wrap">
                    <div class="logo logo-width-1">
                        <a href="{{ url('/') }}"><img src="{{ $siteLogo }}" alt="logo" /></a>
                    </div>
        ...
        <a href="{{ route('compare') }}"><span class="lable ml-0">Compare</span></a>
                ...
                <div class="header-action-icon-2">
                    <a href="{{ route('wishlist') }}">
                        ...
                        <span class="pro-count blue js-wish-qty">0</span>
                    </a>
                ...
                <div class="header-action-icon-2">
                    <a class="mini-cart-icon" href="{{ route('mycart') }}">
                        ...
                        <span class="pro-count blue js-cart-qty">0</span>
                    </a>
          ...
          <!--   // End mini cart start with ajax -->
                        ...
                        <div class="shopping-cart-footer">
                            <div class="shopping-cart-total">
                                <h4>Total <span class="js-cart-subtotal"></span></h4>
                            </div>
    ...
    <div class="header-action-2">
        <div class="header-action-icon-2">
            <a href="{{ auth()->check() ? route('wishlist') : route('login') }}">
                ...
                <span class="pro-count white js-wish-qty">0</span>
            </a>
        </div>
        <div class="header-action-icon-2">
            <a class="mini-cart-icon" href="{{ route('mycart') }}">
                <img alt="Nest" src="{{ asset('frontend/assets/imgs/theme/icons/icon-cart.svg') }}" />
                <span class="pro-count white js-cart-qty">0</span>
            </a>
            <div class="cart-dropdown-wrap cart-dropdown-hm2">
                <div class="js-mini-cart"></div>
                <div class="shopping-cart-footer">
