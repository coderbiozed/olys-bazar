...
Route::middleware(['auth', 'role:vendor'])->group(function () {
    ...
    Route::middleware('active.vendor')->group(function () {
...
Route::controller(PageController::class)->group(function(){
    ...
    Route::get('/delivery-information', 'deliveryInformation')->name('page.delivery');
    Route::get('/privacy-policy', 'privacyPolicy')->name('page.privacy');
    Route::get('/terms-conditions', 'termsConditions')->name('page.terms');
    Route::get('/contact-us', 'contactUs')->name('page.contact');
    Route::post('/contact-us', 'contactStore')->name('page.contact.store');
    Route::get('/support-center', 'supportCenter')->name('page.support');
    Route::get('/careers', 'careers')->name('page.careers');
    Route::get('/affiliate-program', 'affiliateProgram')->name('page.affiliate');
    Route::get('/farm-business', 'farmBusiness')->name('page.farm');
    Route::get('/accessibility', 'accessibility')->name('page.accessibility');
    Route::get('/promotions', 'promotions')->name('page.promotions');
    Route::get('/track-order', 'trackOrder')->name('public.track.order');
    Route::post('/track-order', 'orderTracking')->name('public.order.tracking');
...
Route::controller(StripeController::class)->group(function(){
    ...
    Route::post('/merchant/order' , 'MerchantOrder')->name('merchant.order');
